...
https://www.codewars.com/kata/5a08bb3c80171f4b040000fc/javascript
*/

function speedListen(t,s) {
    t = t.split(':').reduce((t,v) => +v+t*60,0)/s|0;
    return [t/3600|0,(t/60|0)%60,t%60].map(v => (''+v).padStart(2,'0')).join(':');
}
